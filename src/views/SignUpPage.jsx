  ...
  if (success) {
    return (
      <div className="min-h-screen flex items-center justify-center bg-muted/30 px-4">
        <m.div initial={{ scale: 0.9, opacity: 0 }} animate={{ scale: 1, opacity: 1 }} className="text-center max-w-md">
          <CheckCircle className="h-16 w-16 text-primary mx-auto mb-4" />
          <h2 className="text-2xl font-heading font-bold text-foreground mb-2">Account Created!</h2>
          <p className="text-muted-foreground mb-4">Check your email for a verification link to activate your account.</p>
      ...
      <m.div initial={{ opacity: 0, scale: 0.95 }} animate={{ opacity: 1, scale: 1 }} className="w-full max-w-md">
        ...
        <div className="rounded-xl border bg-card p-6 shadow-sm">
          <form onSubmit={handleSubmit} className="space-y-4">
            {error && (
              <m.div initial={{ opacity: 0, y: -4 }} animate={{ opacity: 1, y: 0 }} className="rounded-md bg-destructive/10 p-3 text-sm text-destructive">
                {error}
              </m.div>
            )}
            <div>
          ...
          <div className="grid grid-cols-3 gap-2">
            <Button variant="outline" size="sm" onClick={() => handleSocialLogin("google")} className="text-xs" disabled={loading}>
            ...
            <Button variant="outline" size="sm" onClick={() => handleSocialLogin("github")} className="text-xs" disabled={loading}>
            ...
            <Button variant="outline" size="sm" onClick={() => handleSocialLogin("facebook")} className="text-xs" disabled={loading}>
